...
public class MorseCodeDecoder {
    ...
    the letter A is coded as ·−, letter Q is coded as −−·−, and digit 1 is coded as ·−−−−. The Morse code is
    case-insensitive, traditionally capital letters are used. When the message is written in Morse code, a single space
    is used to separate the character codes and 3 spaces are used to separate words. For example, the message HEY JUDE
    in Morse code is ···· · −·−−   ·−−− ··− −·· ·.
    ...
    public static void main(String[] args) {
        String morse = ".... . -.--   .--- ..- -.. .";
        String decodedMessage = decode(morse);
